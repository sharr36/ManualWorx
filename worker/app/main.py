...
from .tasks.reclassify_heuristic import reclassify_heuristic
...
class WorkerSettings:
    ...
    max_jobs = 10
    job_timeout = 7200  # 2 hours per job (large scanned manuals need Tesseract OCR per page)
